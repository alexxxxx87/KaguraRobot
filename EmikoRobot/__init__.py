...
def get_user_list(__init__, key):
    with open("{}/KaguraRobot/{}".format(os.getcwd(), __init__), "r") as json_file:
        return json.load(json_file)[key]

# enable logging
FORMAT = "[KaguraRobot] %(message)s"
logging.basicConfig(
...
LOGGER = logging.getLogger('[KaguraRobot]')
LOGGER.info("Kagura is starting. | An Alexx Project Parts. | Licensed under GPLv3.")
