...
PM_START_TEXT = """
*Hello {} !*
✪ I'm an anime-theme management bot [✨](https://telegra.ph/file/deece219398bd33634a0f.jpg)
────────────────────────
× *Uptime:* `{}`
× `{}` *users, across* `{}` *chats.*
────────────────────────
...
buttons = [
    [
        InlineKeyboardButton(text=f"About {dispatcher.bot.first_name}", callback_data="Kagura_"),
    ],
    [
...
DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project by contacting @ygmutebabi \
    ...
    if query.data == "Kagura_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Admins", callback_data="Kagura_admin"),
                    InlineKeyboardButton(text="Notes", callback_data="Kagura_notes"),
                 ],
                 [
                    InlineKeyboardButton(text="Support", callback_data="Kagura_support"),
                    InlineKeyboardButton(text="Credits", callback_data="Kagura_credit"),
                 ],
                 [
                    InlineKeyboardButton(text="Source Code", url="https://github.com/alexxxxx87/KaguraRobot"),
                 ],
                 [
        ...
        query.message.edit_text(
            ...
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="Go Back", callback_data="Kagura_")]]
            ),
        )
    elif query.data == "Kagura_support":
        query.message.edit_text(
            text="*๏ Kagura support chats*"
            f"\nJoin My Support Group/Channel for see or report a problem on {dispatcher.bot.first_name}.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Support", url="t.me/ygmutebabi"),
                    InlineKeyboardButton(text="Updates", url="https://t.me/gabutanguwa"),
                 ],
                 [
                    InlineKeyboardButton(text="Go Back", callback_data="Kagura_"),
